    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light newr fixed addborderbottom">
      ...
      <div class="collapse navbar-collapse addborderbottom" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item pad"> <a class="nav-link" href="hiddensummarized.php">SUMMARY </a> </li>
         	<li class="nav-item pad active"> <a class="nav-link" href="#"><span class="sr-only">(current)</span>MY LEAVE</a> </li>
			<li class="nav-item pad"> <a class="nav-link" href="hiddenReports.php">REPORTS</a> </li>
		  </ul>
 ...
 <div class="row rowe">
  ...
  <?php
	...
	<div class="popup lpopup" id="popup">
		...
		<form action="hiddenMy leave.php" method="post">
		 ...
		 <input name="name" type="text" required="required" id="name" class= "form-control" disabled value=<?php echo $_SESSION['username']?>><br>
