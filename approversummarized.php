    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light newr fixed addborderbottom">
      ...
      <div class="collapse navbar-collapse addborderbottom" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item pad active"> <a class="nav-link" href="#">SUMMARY </a><span class="sr-only">(current)</span></li>
			<li class="nav-item pad"> <a class="nav-link" href="approverMy leave.php">MY LEAVE</a> </li>
			<li class="nav-item pad"> <a class="nav-link" href="approverReports.php">REPORTS</a> </li>
		  </ul>
